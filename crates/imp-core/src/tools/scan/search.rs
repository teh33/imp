...
pub(super) fn repo_index_line(index: &[IndexedSymbol]) -> String {
    format!(
...
pub(super) fn repo_index_details(index: &[IndexedSymbol]) -> serde_json::Value {
    json!({
        "symbols": index.len(),
...
pub(super) fn related_symbols<'a>(
